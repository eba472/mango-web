...
const WordOfday = () => {
  ...
  return (
    <div style={{ width:'300px', height:'300px', backgroundColor:'#e76f51', borderRadius:'48%', textAlign:'center' }}>
        <div style={{ fontSize:'20px', color:'#264653', paddingTop:'35px', fontWeight:'bold' }}>
            Word of the day
        </div>
