            ...
            <div>
              ...
              <div className="statistic">
                ...
                <div className="Analyze">
                  ...
                  <p className="ExplanationOfAnalyze">This is a histogram of the typing speeds of all users, and your position in relation to them.</p>
                  <div className="GraphicOfAnalyze">
                    Here will be graphic.
                  </div>
                  <p>See how fast you type relative to other users. The higher the bar is, the more people type at that speed. Your position is marked with the colored vertical lines.</p>
                </div>

                <div className="Analyze">
                  <h5 className="NameOfAnalyze">Learning Progress Overview</h5>
                  <p className="ExplanationOfAnalyze">This chart shows the learning progress overview for all keys.</p>
                  <div className="GraphicOfAnalyze">
                    Here will be graphic.
                  </div>
                  <p>Horizontal axis: lesson number. Vertical axis: typing speed for each individual key,   – slow,   – fast.</p>
                </div>

                <div className="Analyze">
                  <h5 className="NameOfAnalyze">Typing Speed</h5>
                  <p className="ExplanationOfAnalyze">This chart shows how overall typing speed changes over time.</p>
                  <div className="GraphicOfAnalyze">
                    Here will be graphic.
                  </div>
                  <p>Horizontal axis: lesson number. Vertical axis:   – typing speed,   – number of errors,   – number of keys in the lessons.</p>
                </div>

                <div className="Analyze">
                  <h5 className="NameOfAnalyze">Key Typing Speed</h5>
                  <p className="ExplanationOfAnalyze">This chart shows the typing speed change for each individual key.</p>
                  <div className="GraphicOfAnalyze">
                    Here will be graphic.
                  </div>
                  <p>Horizontal axis: lesson number. Vertical axis:   – typing speed for the currently selected key.</p>
                </div>
